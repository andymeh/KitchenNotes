...
GO
/*
The column [dbo].[User].[RememberMe] is being dropped, data loss could occur.
*/
...
GO
/*
The column [dbo].[UserHub].[HubAdmin] on table [dbo].[UserHub] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/

IF EXISTS (select top 1 1 from [dbo].[UserHub])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT
...
GO
ALTER TABLE [dbo].[User] DROP COLUMN [RememberMe];


GO
PRINT N'Altering [dbo].[UserHub]...';


GO
ALTER TABLE [dbo].[UserHub]
    ADD [HubAdmin] BIT NOT NULL;
